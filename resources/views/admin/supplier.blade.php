  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <table id="dataAuthors" class="table table-bordered table-striped" style="width: 100%">
            <thead >
            ...
            <div class="modal-body">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="name" class="form-control" :value="data.name" placeholder="Enter name" required minlength="5" maxlength="30">
                  <label>Email</label>
...
<script type="text/javascript">
  ...
  var controller = new Vue({
    ...
    methods: {
      datatable(){
        const _this = this;
        _this.table = $('#dataAuthors').DataTable({
          ajax: {
            url: _this.apiUrl,
            type:'GET',
          },
